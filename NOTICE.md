...
### 相机模拟与胶片批次（v0.3.0 的 18 款 + v0.4.0 的 38 款）— 自写近似，参数不转录

v0.3.0 的 18 款「相机调色模拟」（Pentax 11、哈苏 HNCS 3、徕卡机身 2、GR 电影调 2）
与 v0.4.0 的 38 款（胶片 24 + 徕卡包 14）均由本项目**自写**，参考是仓库所有者本人的
