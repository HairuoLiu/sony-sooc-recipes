...
本文件夹记录 **v0.6.0 发布版附带的每一个 APK**：全量版（all-in-one）加八个单品牌包。
...
| Fujifilm Looks | `com.hairuoliu.sonysoocrecipes.fujifilm` | **26** | 2 | [fujifilm](fujifilm.zh-CN.md) |
...
| Ilford Looks | `com.hairuoliu.sonysoocrecipes.ilford` | **5** | 1 | [ilford](ilford.zh-CN.md) |
...
**140 + 20 + 26 + 11 + 20 + 11 + 5 + 4 + 8 = 245** 条「配方列表」，但底层目录其实只有
