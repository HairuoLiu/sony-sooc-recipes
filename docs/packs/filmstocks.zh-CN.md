...
**一句话概览：** 本包从 **Fuji Film** 来源分组编译了 **10** 个彩色配方，把富士真实的*胶卷*以索尼设置还原。
...
这些都是**近似还原**，并非富士自家的胶片化学。a6000 级别的索尼机身只能存储普通的机内设置（创意风格、饱和度、对比度、锐度、可选的照片效果、曝光补偿、DRO），无法载入真实的胶片乳剂。部分为社区创作、未经实测验证，请当作可调的起点。
